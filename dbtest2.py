...
def create_products_table():
    ...
    try:
        ...
        CREATE TABLE IF NOT EXISTS products (
            ...
            image_url VARCHAR(500)  -- Added column for S3 image paths
        );
        '''
        cursor.execute(create_table_query)
        connection.commit()
    ...
    try:
        ...
        with open(file_path, mode='r', encoding='utf-8') as csvfile:
            ...
            for row in csv_reader:
                insert_query = '''
                INSERT INTO products (Item_id, Main_Category, Sub_Categories, Item_Code, Product_Title, Product_Description, Price, image_url)
...
if __name__ == "__main__":
    ...
    csv_file_path = 'C:\\Kalisoft_project\\Kalika_projects\\kalika_catalog_products_s3.csv'
