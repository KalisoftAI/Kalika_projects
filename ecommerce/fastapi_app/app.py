...
def add_product_to_db(product_data: dict):
    ...
    if not data.get('item_id') or not data.get('item_code'):
        logger.error("Cannot add product: 'item_id' and 'item_code' are required.")
        return False
    ...
    try:
        ...
        insert_query = f"INSERT INTO products ({', '.join(columns_to_insert)}) VALUES ({placeholders});"
        
        cursor.execute(insert_query, tuple(data_values))
        conn.commit()
        logger.info(f"Product '{data.get('product_title')}' successfully added with item_id {data.get('item_id')}.")
        return True
    except Exception as e:
...
def update_product_in_db(item_id: int, product_data: dict):
    ...
    field_to_column_map = {
        'productname': 'product_title', 'productcategory': 'main_category',
        'productsubcategory': 'sub_categories', 'productdescription': 'product_description',
        'listprice': 'list_price', 'minorderqty': 'min_order_qty',
        'leadtime': 'lead_time', 'materialtype': 'material_type',
        'sysnumimages': 'sys_num_images', 'sysproducttype': 'sys_product_type',
...
@app.post("/admin/bulk-modify-properties")
...
@app.get("/admin/api/products-for-dropdown")
...
@app.get("/admin/items", name="items_page")
...
@app.get("/admin/edit-product", name="edit_product_page")
...
@app.get("/admin/advance-edit", name="advance_edit_page")
...
@app.post("/admin/api/product-details")
...
@app.post("/admin/products/update_properties")
...
@app.get("/admin/products", name="items_page") # Renamed from 'products' to 'items_page' for clarity in menu
...
@app.get("/admin/products/add", name="add_products_get") # Route name changed to match template
...
@app.get("/admin/bulk-modify", name="import_from_xl_page") # Added name
...
@app.post("/admin/bulk-modify-properties-column")
...
@app.get("/admin/api/nested-categories")
...
@app.get("/admin/api/export-status")
...
@app.get("/admin/export-status", name="export_status_page")
...
@app.get("/admin/api/categories-from-db")
...
@app.get("/admin/pending-orders", name="pending_orders") # Added name
...
@app.get("/admin/orders", name="completed_orders") # Added name
...
@app.get("/admin/users", name="user_list") # Added name
...
@app.get("/admin/users/add", name="add_user_get") # Added name
...
@app.get("/admin/users/edit/{user_id}", name="edit_user") # Added name
...
@app.post("/admin/users/edit/{user_id}", name="edit_user_post") # Added name
...
@app.get("/admin/punchout", name="punchout_list") # Added name
...
@app.get("/admin/analytics", name="analytics") # Added name
...
@app.get("/admin/settings", name="settings") # Added name
...
@app.get("/admin/help", name="help_page") # Added name
...
@app.get("/admin/logout", name="logout") # Added name
...
@app.get("/admin/categories", name="categories_page")
...
@app.get("/admin/item-options", name="item_options_page")
...
@app.get("/admin/inventory", name="inventory_page")
...
@app.get("/admin/export-file", name="export_file_page")
